      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase text-[var(--background)]">{t("Footer.Resources")}</h2>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase text-[var(--background)]">{t("Footer.FollowUs")}</h2>
              <ul className="font-medium text-[var(--background)]">
                <li className="mb-4">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase text-[var(--background)]">{t("Footer.Legal")}</h2>
              <ul className="font-medium text-[var(--background)]">
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="https://www.youtube.com/c/DataICMC" className="hover:text-primary me-5">
              <FaInstagram className="w-4 h-4" />
              <span className="sr-only">YouTube</span>
            </a>
            <a href="https://www.instagram.com/data.icmc/" className="hover:text-primary me-5">
